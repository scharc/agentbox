...
class WorktreeMetadata:
    """Manages worktree metadata stored in .agentbox/worktrees.json"""

    def __init__(self, agentbox_dir: str = "/workspace/.agentbox"):
        self.agentbox_dir = agentbox_dir
        self.metadata_file = os.path.join(agentbox_dir, "worktrees.json")

    def _ensure_agentbox_dir(self):
        """Ensure .agentbox directory exists"""
        Path(self.agentbox_dir).mkdir(parents=True, exist_ok=True)
