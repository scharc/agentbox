"""Agentctl CLI - tmux session management for agentbox containers"""
...
@click.pass_context
def cli(ctx):
    """Agentctl - Tmux session management inside agentbox

    Manage tmux sessions for AI agents and shells within agentbox containers.
...
def attach(agent: str):
    ...
    """
    # Sanitize session name (same logic as agentbox uses)
