...
"""Tmux session management for web UI using existing agentbox helpers."""

import logging
import subprocess
from typing import List, Dict, Optional
from agentbox.container import ContainerManager
from agentbox.cli.helpers import _get_tmux_sessions, _get_tmux_socket
...
def _build_tmux_cmd(socket_path: Optional[str], *args: str) -> list[str]:
    ...
    """
    if socket_path:
        return ["/usr/bin/tmux", "-S", socket_path, *args]
    return ["/usr/bin/tmux", *args]
