// Status page management for Agentbox Web UI
        ...
        <section class="status-section">
            ...
            <div class="status-card service-card">
                <div class="status-row">
                    <span class="status-label">agentboxd</span>
                ...
                <div class="action-row">
                    <button class="action-btn btn-warning" onclick="confirmAction('restart-service', 'Restart Service', 'This will restart the agentboxd service. Active connections may be briefly interrupted.')">
                        &#8635; Restart Service
                    </button>
                </div>
            </div>
