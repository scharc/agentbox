...
"""Tests for .agentbox.yml configuration."""
...
def test_agentbox_yml_properties(test_project):
    """Test that ProjectConfig reads all properties from .agentbox.yml."""
    from agentbox.config import ProjectConfig

    # Create .agentbox.yml with all sections
...
def test_workspace_cli_writes_to_yml(test_project, workspace_dir):
    """Test that 'agentbox workspace add' writes to .agentbox.yml."""
    # Create .agentbox.yml first
    config_file = test_project / ".agentbox.yml"
...
def test_container_connection_from_yml(test_project):
    """Test that container connections from .agentbox.yml are applied."""
    # Create .agentbox.yml with container connection
    config_file = test_project / ".agentbox.yml"
    config_data = {
        "version": "1.0",
        "containers": [
...
def test_network_cli_writes_to_yml(test_project):
    """Test that 'agentbox network connect' writes to .agentbox.yml."""
...
def test_ssh_forward_agent_env_var(test_project, tmp_path):
    ...
    # Create .agentbox.yml with agent forwarding
    config_file = test_project / ".agentbox.yml"
    config_data = {
        "version": "1.0",
        "ssh": {
...
def test_resources_applied_to_container(test_project):
    """Test that resource limits from .agentbox.yml are applied to container."""
    config_file = test_project / ".agentbox.yml"
    config_data = {
        "version": "1.0",
        "resources": {
...
def test_security_options_applied(test_project):
    """Test that security options from .agentbox.yml are applied."""
    config_file = test_project / ".agentbox.yml"
    config_data = {
        "version": "1.0",
        "security": {
...
def test_port_mappings_applied(test_project):
    """Test that port mappings from .agentbox.yml are applied."""
    import socket
...
def test_devices_property(test_project):
    """Test that devices property reads from .agentbox.yml."""
    from agentbox.config import ProjectConfig
...
def test_devices_applied_to_container(test_project):
    """Test that device mappings from .agentbox.yml are applied to container."""
    config_file = test_project / ".agentbox.yml"
    config_data = {
        "version": "1.0",
        "devices": ["/dev/null"],
