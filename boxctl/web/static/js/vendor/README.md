...
This directory contains third-party JavaScript libraries used by the boxctl Web UI.
...
curl -sL https://cdn.jsdelivr.net/npm/ansi_up@X.Y.Z/ansi_up.min.js \
  -o /workspace/boxctl/web/static/js/vendor/ansi_up.min.js

# Or use npm if available
npm install ansi_up
cp node_modules/ansi_up/ansi_up.min.js /workspace/boxctl/web/static/js/vendor/
```
